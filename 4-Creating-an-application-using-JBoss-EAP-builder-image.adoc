...
ks        ks-myjbossapp-Username.apps.telus-0af8.openshiftworkshop.com              ks         8080-tcp
....
...
Go to http://ks-myjbossapp-UserName.telus-0af8.openshiftworkshop.com  via your browser.

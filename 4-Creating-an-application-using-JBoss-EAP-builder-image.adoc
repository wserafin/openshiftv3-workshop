...
ks        ks-myjbossapp-Username.apps.toronto-50eb.openshiftworkshop.com              ks         8080-tcp
....
...
....
$ curl ks-myjbossapp-UserName.apps.toronto-50eb.openshiftworkshop.com
...
Go to http://ks-myjbossapp-UserName.apps.telus-ea2b.openshiftworkshop.com  via your browser.

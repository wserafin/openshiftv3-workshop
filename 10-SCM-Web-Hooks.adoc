...
....
$ oc expose service scm-web-hooks --hostname=scm-web-hooks.UserName.<<DomainNameSuffix>> 
NAME            HOST/PORT                                  PATH      SERVICE         LABELS              TLS TERMINATION
scm-web-hooks   scm-web-hooks.UserName.<<DomainNameSuffix>>              scm-web-hooks   app=scm-web-hooks
....

*Step 5: Test the application*

* Use the newly created route, in the above case
`scm-web-hooks.UserName.<<DomainNameSuffix>> ` and paste it in your browser.
* You should see:

...
....
$ oc expose service blue --hostname=bluegreen-UserName.apps.toronto-50eb.openshiftworkshop.com --name=bluegreen
....
...
spec:
  host: bluegreen-UserName.apps.toronto-50eb.openshiftworkshop.com
  port:
    targetPort: "8080"
  to:
    kind: Service

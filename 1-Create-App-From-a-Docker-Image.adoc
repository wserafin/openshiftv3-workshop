...
* CONSOLE: https://master.toronto-50eb.openshiftworkshop.com

* LABs: http://labs-workshop.apps.toronto-50eb.openshiftworkshop.com 

Optional: 

* TERMIAL: http://termial-workshop.apps.toronto-50eb.openshiftworkshop.com 

....
oc login https://master.toronto-50eb.openshiftworkshop.com
....
...
....
$ oc expose service welcome --name=welcome --hostname=welcome-UserName.apps.toronto-50eb.openshiftworkshop.com

NAME      HOST/PORT                     PATH      SERVICE   LABELS
welcome   welcome.UserName.apps.workshop.osecloud.com             welcome
....

*Step 4: curl -Is http://welcome-UserName.apps.toronto-50eb.openshiftworkshop.com
...
Now delete project.
....
$ delete project mycliproject_username    ( replace your username ) 
....

...
* CONSOLE: https://master.telus-0af8.openshiftworkshop.com

* LABs: http://labs-workshop.apps.telus-0af8.openshiftworkshop.com

Optional: 

* TERMIAL: http://terminal-workshop.apps.telus-0af8.openshiftworkshop.com

* oc login https://master.telus-0af8.openshiftworkshop.com

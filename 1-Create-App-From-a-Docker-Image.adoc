...
* CONSOLE: https://ocpdemo.com:8443

* LABs: http://labs-workshop.apps.ocpdemo.com  

Optional: 

* TERMIAL: http://cli-inabox.apps.ocpdemo.com 

....
oc login https://ocpdemo.com:8443 
....
...
....
$ oc expose service welcome --name=welcome --hostname=welcome-UserName.apps.ocpdemo.com

NAME      HOST/PORT                     PATH      SERVICE   LABELS
welcome   welcome.welcome-UserName.apps.ocpdemo.com             welcome
....

*Step 4: curl -Is http://welcome-UserName.apps.ocpdemo.com

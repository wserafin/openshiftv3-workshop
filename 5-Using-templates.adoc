...
****
WARNING: Before finsihing use `Advanced Options` SECTION !!!!
*****
...
Using project "consoleproject-Username" on server "ocpdemo.com:8443".
...
pricelist   pricelist-consoleproject-Username.apps.ocpdemo.com 	                   pricelist   8080-tcp      None
....

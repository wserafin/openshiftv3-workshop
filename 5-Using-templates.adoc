...
Using project "consoleproject-Username" on server "master.apps.toronto-50eb.openshiftworkshop.com".
...
pricelist   pricelist-consoleproject-Username.apps.toronto-50eb.openshiftworkshop.com pricelist   8080-tcp      None
....
